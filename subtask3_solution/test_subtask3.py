"""
Testing/Evaluation Script for SemEval 2026 Task 9 - Subtask 3
Multi-label Classification for Polarization Manifestations
...
class MultiLabelDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label = self.labels[idx] if self.labels is not None else [0] * 6
...
class ModelPredictor:
    """
    Model predictor for multi-label polarization manifestation classification
    """
...
def evaluate_model(predictor, test_df, output_dir=None):
    ...
    # Print results
    logger.info("\n" + "="*60)
    logger.info("Evaluation Results - Subtask 3")
    logger.info("="*60)
...
def test_by_language(predictor, data_dir, split='dev', output_dir=None):
    ...
    # Languages (note: Italian excluded from subtask 3)
    languages = [
...
def main():
    parser = argparse.ArgumentParser(
        description='Test model for SemEval 2026 Task 9 - Subtask 3'
    )
    ...
    parser.add_argument(
        '--data_dir',
        type=str,
        default='c:/hishab/semeval-2026/dev_phase/subtask3',
        help='Directory containing subtask3 data (train/dev folders)'
    )
    ...
    parser.add_argument(
        '--output_dir',
        type=str,
        default='./subtask3_solution/results',
    ...
    parser.add_argument(
        '--submission_output',
        type=str,
        default='./subtask3_solution/submission.csv',
